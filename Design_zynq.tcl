...
#
# Design_zynq.tcl: Tcl script for re-creating project 'Design_zynq'
#
# Generated by Vivado on Fri Jun 26 10:47:44 +0200 2026
...
#
# 1. This project restoration tcl script (Design_zynq.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "D:/Design_zynq/Design_zynq.srcs/sources_1/new/encoder.v"
#    "D:/Design_zynq/Design_zynq.srcs/constrs_1/new/constraints.xdc"
#    "D:/Design_zynq/Design_zynq.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/Design_zynq.srcs/sources_1/new/encoder.v"]"\
 "[file normalize "$origin_dir/Design_zynq.srcs/constrs_1/new/constraints.xdc"]"\
 "[file normalize "$origin_dir/Design_zynq.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "Design_zynq"
...
set script_file "Design_zynq.tcl"
...
set_property -name "board_part_repo_paths" -value "C:/Users/pardi/AppData/Roaming/Xilinx/Vivado/2025.2/xhub/board_store/xilinx_board_store" -objects $obj
...
set file "[file normalize "$origin_dir/Design_zynq.srcs/constrs_1/new/constraints.xdc"]"
...
if { [get_files [list encoder.v]] == "" } {
  import_files -quiet -fileset sources_1 D:/Design_zynq/Design_zynq.srcs/sources_1/new/encoder.v
}
...
# encoder
  ...
  # Create ports
  set addr_0 [ create_bd_port -dir O -from 2 -to 0 addr_0 ]
...
\
  ...
  set_property CONFIG.C_NUM_SS_BITS {8} $axi_quad_spi_0
  ...
  [get_bd_pins encoder_0/ss_n]
  connect_bd_net -net encoder_0_addr  [get_bd_pins encoder_0/addr] \
  [get_bd_ports addr_0]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"42,-719",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.8.0 2024-04-26 e1825d835c VDI=44 GEI=38 GUI=JA:21.0 threadsafe
#  -string -flagsOSRD
preplace port spi_rtl -pg 1 -lvl 5 -x 1540 -y -410 -defaultsOSRD
preplace portBus addr_0 -pg 1 -lvl 5 -x 1540 -y -280 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 2 -x 640 -y -150 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 3 -x 1130 -y -150 -defaultsOSRD
preplace inst axi_quad_spi_0 -pg 1 -lvl 1 -x 190 -y 10 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 2 -x 640 -y -530 -defaultsOSRD
preplace inst encoder_0 -pg 1 -lvl 4 -x 1410 -y -280 -defaultsOSRD
preplace inst ilconstant_0 -pg 1 -lvl 1 -x 190 -y -650 -defaultsOSRD
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 0 4 50 -190 320 -290 N -290 1300
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 3 70 -180 330J -240 950
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 2 1 960 -170n
preplace netloc axi_quad_spi_0_ss_o 1 1 3 350J -280 NJ -280 N
preplace netloc encoder_0_addr 1 4 1 N -280
preplace netloc ilconstant_0_dout 1 1 1 310 -650n
preplace netloc axi_interconnect_0_M00_AXI 1 0 3 60 -710 NJ -710 940
preplace netloc axi_quad_spi_0_SPI_0 1 1 4 340 -410 N -410 NJ -410 N
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 1 2 350 -650 930
levelinfo -pg 1 -360 190 640 1130 1410 1540
pagesize -pg 1 -db -bbox -sgen -480 -720 1660 200
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/Design_zynq.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
